...
export const godfatherData = [
    {
        ...
        text: '"MAMÁ Y BEBÉ"  El compromiso de amor que adquieren los padrinos es acompañar a la madre embarazada asignada, hasta seis meses después de nacido el bebé y la apoya con un Kit de nacimiento.',
